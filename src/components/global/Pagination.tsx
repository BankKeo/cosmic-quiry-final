...
const Pagination: React.FC<IProps> = ({ total, callback }) => {
  ...
  const hadlePagination = (num: number) => {
  ...
  return (
    <nav aria-label="Page navigtion example" style={{ cursor: "pointer" }}>
      <ul className="pagination">
        ...
        {page < total && (
          <li className="page-item" onClick={() => hadlePagination(page + 1)}>
